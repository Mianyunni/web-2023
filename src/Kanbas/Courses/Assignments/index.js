        ...
        <div>
            <div className="d-flex align-items-center justify-content-between mt-3" style={{ backgroundColor: '#ffffff', padding: '10px', borderRadius: '5px' }}>
                ...
                <div className="d-flex">
                    ...
                    <button className="btn btn-danger" onClick={() => navigate(`/Kanbas/Courses/${courseId}/AssignmentEditor`)}><BsPlus /> Assignment</button>
                ...
                {courseAssignments.map((assignment) => (
                    ...
                    >
                        <div>
                            ...
                            <GiNotebook style={{ marginRight: '5px', color: 'green' }} />
                            {assignment.title}
                        </div>
                        <div className="d-flex">
